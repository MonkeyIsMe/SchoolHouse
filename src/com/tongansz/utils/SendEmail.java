...
public class SendEmail {
	...
	public void UserForgetPassword(int userid) throws IOException{
		String myEmailAccount = "altmen_121819@163.com";
	    ...
	    if(email == null || email == "") {
	      ...
	      // 2. 根据配置创建会话对象, 用于和邮件服务器交互
	         ...
	         try {
	 	        ...
	 	        String Spassword = MD5.md5(password);
	 	        user.setUserPassword(Spassword);
	 	        user.setUserPasswords(password);
	 	        ud.update(user);
	 	        message.setContent("用户你好, 新密码为"+ num +"由于密码过于简单，请及时登录后修改您的密码！！", "text/html;charset=UTF-8");
	...
	public void ForgetPassword(int userid) throws IOException {
	    ...
	    SchoolUser user= ud.query(userid);
	    String email = user.getUserEmail();
