...
var stu_str;
// 标志是否已经导入了excel或者添加了学校数据，如果flag为0，则该项操作是第一次
var flag = 0;
// excel的记录条数
var excel_num = 0;
// 添加学生信息
...
$("#mySave").click(function() {
    excel_num += 1;
    if(flag == 0){
        html += '<tr><th>#</th><th>学校名称</th><th>学校地址</th><th>所属街道</th><th>所属学区</th><th>法人代表</th><th>联系电话</th><th>创建时间</th></tr>';
        html += "<tr><td>"+excel_num+"</td><td>"+$("#schoolName").val()+"</td><td>"+$("#schoolAddress").val()+"</td><td>"+$("#schoolStreet").val()+"</td><td>"+$("#areaName").val()+"</td><td>"+$("#schoolIegalPerson").val()+"</td><td>"+$("#schoolPhone").val()+"</td></table>";

        stu_str = '[{"学校名称":"'+$("#schoolName").val()+'","学校地址":"'+$("#schoolAddress").val()+'","所属街道":"'+$("#schoolStreet").val()+'","所属学区":"'+$("#areaName").val()+'","法人代表":"'+$("#schoolIegalPerson").val()+'","联系电话":"'+$("#schoolPhone").val()+'"}]';    
        //console.log(stu_str);
    }else if(flag == 1) {
        // 去掉后面的</table>
        html = html.substring(0,html.length-8);
        html += "<tr><td>"+excel_num+"</td><td>"+$("#schoolName").val()+"</td><td>"+$("#schoolAddress").val()+"</td><td>"+$("#schoolStreet").val()+"</td><td>"+$("#areaName").val()+"</td><td>"+$("#schoolIegalPerson").val()+"</td><td>"+$("#schoolPhone").val()+"</td><td>"+$("#schoolCreatTime").val()+"</td></tr></table>";
